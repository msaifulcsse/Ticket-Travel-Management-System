<?php
  ...
  $sql6 = "select * from user_ticket_info where flight_id = '$flightId'";
...
<h3 style="color: coral"><u>Your Ticket Informations</u></h3>
      ...
      <a href="userFlight_t_print.php"><h3 style="background-color: green;border: none;color: white; font-size: 20px;display: inline-block;">Print Your Ticket</h3></a>
