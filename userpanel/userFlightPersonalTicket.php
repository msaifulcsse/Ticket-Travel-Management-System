<?php
  ...
  $getUID = $_SESSION["UserID"];
        $sql = "SELECT * FROM user_info, user_ticket_info where user_ticket_info.bus_id IS NULL AND user_ticket_info.train_id IS NULL AND user_info.user_id = '$getUID' and user_ticket_info.user_id = '$getUID' and user_ticket_info.ticket_id = '$id'";
