...
<body background="images/biman.jpg">
    <header>
           ...
           <table>
             <tr>
              ...
              <tr>
               ...
               <td style="background-color: 008080; color: white; font-size: 20px;"><input type="text" name="ddate" id="ddate" required/></td> <!--We can use disabled || readonly also-->
             </tr>
             <tr>
              ...
              <tr>
              <th colspan="2"><input type="submit" name="submit" value="Search Desire Flight" style="background-color: coral; color: white; font-size: 20px;" /></th>
              </tr>   
            </table>
         </form>
      </div>
