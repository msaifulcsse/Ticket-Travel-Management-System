  ...
  { 
    ...
    $sql = "update bus_trips set avai_seat = avai_seat-$count where bus_id=$busId;"; 
     ...
     //*****************//
      ...
      $sql1 = "insert into user_ticket_info (user_id,bus_id,vehicle_name, pay_method, amount, seats, category, route, jdate, jtime) values ('$getUID','$busId','$v_name','$payment','$amount','$seatNum','$category','$route','$jdate','$jtime');";
      if(!mysql_query($sql1))
        echo mysql_error();
      else
        {
