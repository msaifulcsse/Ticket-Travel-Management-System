  ...
  $err = "";
   if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST['submit']))
      {    
        ...
        $sql ="INSERT INTO bus_trips (tourdate, b_name, deptfrom, goingto, category, dept_time, arri_time, fare_per_seat, avai_seat) VALUES ('$date', '$b_name', '$dept_from', '$going_to', '$category', '$dept_time', '$arri_time', '$fare', 41)";
        if(!mysql_query($sql))
          {
 ...
 <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="adminBus.php" class="selected">BusInfo</a></li>
...
<center>
<h3 style="color: #2F4F4F;"> Admin Panel || Buses </h3>
...
<form method="POST">
  <h3 style="background-color: FF4500;color: white;"> Available Trips</h3><br>
    <table border="1" style="border-collapse: collapse; width:100%;">
      ...
      <td onclick="document.location = 'busTripDelete.php?id=<?php echo urlencode($row['bus_id']);?>'" style="background-color: coral; color: white; font-size: 20px; cursor:hand;">Delete</td>
      </tr>                
<?php
   }
?>
