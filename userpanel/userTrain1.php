            ...
            <?php
              while($row = mysql_fetch_array($result)) {
               ...
               $_SESSION["route"] =  $row['deptfrom'] ." - ". $row['goingto']?>              
                ...
                <td onclick="document.location = 'userTrainSeat.php?id=<?php echo urlencode($tid);?>'" style="background-color: coral; color: white; font-size: 20px; cursor:hand;">Show Seat</td>
                </tr>                
          <?php
          }
        }
