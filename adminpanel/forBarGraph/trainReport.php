 ...
 <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="flightReport.php">Flight Report</a></li>
          <li><a href="../adminBus.php">Buse Info</a></li>
          <li><a href="busReport.php">Bus Report</a></li>
          <li><a href="../adminTrain.php">Train Info</a></li>
          <li><a href="trainReport.php" class="selected">Train Report</a></li>
...
<br/> <br/>
    ...
    <script type="text/javascript" src="trainApp.js"></script>
</body>
</html>